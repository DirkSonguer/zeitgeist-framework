...
class parameterhandler
{
	...
	public function index($parameters=array())
	{
		...
		// The parameterhandler filters user input that arrives via REQUEST
		// methods (GET, POST, COOKIE). It is executed transparently by the 
		// eventhandler. So if you got to this point via the normal pipeline
		...
		// .ini file of the module. If you open the parameterhandler.ini
		...
		echo '<a href="./index.php?module=parameterhandler&teststring=abc">Test first parameter with 3 chars (fail)</a><br />';
		echo '<a href="./index.php?module=parameterhandler&teststring=abcde">Test first parameter with 5 chars (success)</a><br /><br />';
		...
		echo '<a href="./index.php?module=parameterhandler&testnumber=abc">Test second parameter with string (fail)</a><br />';
		echo '<a href="./index.php?module=parameterhandler&testnumber=123">Test second parameter with number (success)</a><br /><br />';
		...
		echo '<a href="./index.php?module=parameterhandler&testescape=abc">Test third parameter with normal string (normal)</a><br />';
		echo '<a href="./index.php?module=parameterhandler&testescape=escap\'d">Test second parameter with special chars (escaped)</a><br /><br />';
