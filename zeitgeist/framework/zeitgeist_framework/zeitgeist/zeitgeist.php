...
// include core classes
	if (!defined('DEBUGMODE')) require_once (ZEITGEIST_ROOTDIRECTORY . 'classes/debugdummy.class.php');
		else require_once (ZEITGEIST_ROOTDIRECTORY . 'classes/debug.class.php');
...
// include modules
	require_once (ZEITGEIST_ROOTDIRECTORY . 'modules/formhandler.class.php');
