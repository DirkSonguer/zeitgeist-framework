...
establishUserSession will try to pick up an existing user session. For more information see [ClassUserhandler](http://code.google.com/p/zeitgeist-framework/wiki/ClassUserhandler).
