...
class pkTemplate extends zgTemplate
{
	protected $user;
	protected $basepath;
	...
	public function __construct()
	{
		...
		$this->basepath = $this->configuration->getConfiguration('pocketkun', 'application', 'basepath');
		$this->templatepath = $this->basepath . '/templates/' . $this->configuration->getConfiguration('pocketkun', 'application', 'templatepath');
	}
