...
class gc_dash
{
	...
	function execute()
	{
		...
		$currentGamestates['playerdata'][$currentGamestates['round']['currentPlayer']]['vector'][0] *= 2;
		$currentGamestates['playerdata'][$currentGamestates['round']['currentPlayer']]['vector'][1] *= 2;
